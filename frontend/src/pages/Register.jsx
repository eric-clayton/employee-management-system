        ...
        <div style={styles.card}>
          ...
          <div style={styles.cardHeader}>
            ...
            <p style={styles.subtitle}>
              Join Employee Management System and<br />get started managing your team!
            </p>
          </div>
            ...
            <form onSubmit={handleRegister}>
              ...
              <div style={styles.fieldGroup}>
                ...
                <select
                  style={{
                    ...styles.input,
                    borderColor: errors.role ? '#ef4444' : role ? '#7c3aed' : '#e2e8f0',
              ...
              {errorMessage && (
                <p style={styles.globalError}>{errorMessage}</p>
              )}

              <button type="submit" style={styles.submitBtn}
                onMouseOver={(e) => (e.target.style.background = 'linear-gradient(135deg, #6d28d9, #4f46e5)')}
                onMouseOut={(e) => (e.target.style.background = 'linear-gradient(135deg, #7c3aed, #6366f1)')}
              >
                Create Account
              </button>
